...
export const translations = {
  en: {
    ...
    branchManagement: "Branches & Multi-Store Control",
    activeBranch: "Active Branch",
    allBranches: "All Branches",
    addBranch: "Add New Branch",
    branchName: "Branch Name *",
    branchCode: "Branch Code (e.g., BR-01)",
    branchAddress: "Address",
    branchPhone: "Contact Phone",
    branchManager: "Manager Name",
    isMainBranch: "Main Branch",
    stockTransfer: "Stock Transfer Between Branches",
    transferStock: "Transfer Stock",
    fromBranch: "Source Branch (From)",
    toBranch: "Destination Branch (To)",
    transferQty: "Transfer Quantity",
    transferHistory: "Transfer History Logs",
    branchComparison: "Branch Sales Comparison",
  ...
  my: {
    ...
    aiAnalyst: "AI Business Analyst",
    branches: "ဆိုင်ခွဲများ စီမံခန့်ခွဲမှု",
    branchManagement: "ဆိုင်ခွဲများ စီမံခန့်ခွဲခြင်းစနစ်",
    activeBranch: "လက်ရှိ ဆိုင်ခွဲ",
    allBranches: "ဆိုင်ခွဲ အားလုံး",
    addBranch: "ဆိုင်ခွဲအသစ် ထည့်မည်",
    branchName: "ဆိုင်ခွဲအမည် *",
    branchCode: "ဆိုင်ခွဲကုဒ် (ဥပမာ- BR-01)",
    branchAddress: "ဆိုင်ခွဲလိပ်စာ",
    branchPhone: "ဆက်သွယ်ရန်ဖုန်း",
    branchManager: "ဆိုင်ခွဲတာဝန်ခံအမည်",
    isMainBranch: "ပင်မဆိုင် (Main Branch)",
    stockTransfer: "ဆိုင်ခွဲများအကြား စတော့လွှဲပြောင်းခြင်း",
    transferStock: "စတော့ လွှဲပြောင်းမည်",
    fromBranch: "ပေးပို့သည့် ဆိုင်ခွဲ (From)",
    toBranch: "လက်ခံသည့် ဆိုင်ခွဲ (To)",
    transferQty: "လွှဲပြောင်းမည့် အရေအတွက်",
    transferHistory: "စတော့လွှဲပြောင်းမှု မှတ်တမ်း",
    branchComparison: "ဆိုင်ခွဲအလိုက် ရောင်းအား နှိုင်းယှဉ်ချက်",
